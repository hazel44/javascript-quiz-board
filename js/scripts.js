$(document).ready(function(){
  ...
  var answer3 = parseInt($("input:radio[name = answer4]:checked").val());
  var answer4 = parseInt($("input:radio[name = answer5]:checked").val());

  var total = answer1 + answer2 + answer3 + answer4 + answer5;
  // $("form").hide();
  // $("button").hide();
  // $("#results").text("Your score is" + results +"out of 25")
